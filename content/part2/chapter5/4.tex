...
\mySubsubsection{5.4.1}{Creating a skeleton for the check}
...
\mySubsubsection{5.4.2}{Clang-Tidy check implementation}
...
\mySubsubsection{5.4.3}{LIT test}
...
\mySubsubsection{5.4.4}{Results in the case of compilation errors}
...
\mySubsubsection{5.4.5}{Compilation errors as edge cases}
